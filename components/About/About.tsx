...
export default function About() {
    return (
        <div id="about" className="h-full">
            ...
            >
                {/* Status Badge */}
                <div className="absolute top-8 right-8 flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 items-start">
                        ...
                        <motion.div
                            ...
                            className="relative w-32 h-32 flex-shrink-0 rounded-full overflow-hidden border-2 border-white/10 shadow-2xl group"
                        >
                            <Image
                                src="/MyAvatar.png"
                                alt="Prashant Basnet"
